...
<body bgcolor="eedddd">
	...
	<hr/>
	<form>
		<input type="button" value="삭제" onclick="location.href='./delete?artclId=${article.articlId}'" /> 
		<input type="button" value="수정" onclick="location.href='./edit?artclId=${article.articlId}'" /> 
